...
class CRUDS
{
    ...
    function table_list()
    {
        ...
        $query = "SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME NOT LIKE 'users' AND TABLE_NAME NOT LIKE 'users_groups' AND TABLE_NAME NOT LIKE 'groups' AND TABLE_NAME NOT LIKE 'login_attempts' AND TABLE_NAME NOT LIKE 'menu' AND TABLE_SCHEMA=?";
